...
(to map to chapter or add as footnote)
  ...
  - "The only two products not covered by product liability are religion and software, and software shall not escape much longer", Dan Geer (BH or DC keynote)
  - "Two kinds of companies, those that have been hacked and those that do not know it yet"
  - "A widespread view holds that the US and US tech companies have disproportionately captured the economic benefits of the global internet" (find source)
